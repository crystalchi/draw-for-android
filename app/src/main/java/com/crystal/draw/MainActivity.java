...
public class MainActivity extends AppCompatActivity {
    ...
    @OnClick(R.id.btn_draw_23)
    void draw23(){
        UIHelper.start(this, Draw23Activity.class);
    }
    ...
    @OnClick(R.id.btn_draw_28)
    void draw28(){
        UIHelper.start(this, Draw28Activity.class);
    }

    @OnClick(R.id.btn_draw_29)
    void draw29(){
        UIHelper.start(this, Draw29Activity.class);
    }

    @OnClick(R.id.btn_draw_30)
    void draw30(){
    ...
    @OnClick(R.id.btn_draw_33)
    void draw33(){
        UIHelper.start(this, Draw33Activity.class);
    }

    @OnClick(R.id.btn_draw_34)
    void draw34(){
        UIHelper.start(this, Draw34Activity.class);
    }

    @OnClick(R.id.btn_draw_35)
    void draw35(){
