...
public class BaseDragZoomImageView extends ImageView implements View.OnTouchListener{
    ...
    private static final String TAG = BaseDragZoomImageView.class.getSimpleName();
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                Log.d(TAG, "ACTION_DOWN -- currentMatrix is " + currentMatrix.toShortString());
        ...
        Log.d(TAG, "currentMatrix is " + currentMatrix.toShortString());
